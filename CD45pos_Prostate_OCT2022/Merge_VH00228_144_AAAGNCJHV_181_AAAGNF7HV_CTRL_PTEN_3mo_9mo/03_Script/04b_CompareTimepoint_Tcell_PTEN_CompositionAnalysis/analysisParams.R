...
ANALYSIS_STEP_NAME = "04b_CompareTimepoint_Tcell_PTEN_CompositionAnalysis"

PATH_ANALYSIS_OUTPUT = file.path( PATH_EXPERIMENT_OUTPUT, ANALYSIS_STEP_NAME)

LITERAL_TITLE = "Comparison of timepoints - T cell PTEN - Analysis of differential composition"
