...
read_chunk( path=file.path( WORKING_DIR, "02_analyseComposition.R"));
...
## Loading of data {.tabset .tabset-fade}
...
## Analysis of data composition {.tabset .tabset-fade}

```{r rmd_composition_analysis, fig.dim= c( 12,10)}
