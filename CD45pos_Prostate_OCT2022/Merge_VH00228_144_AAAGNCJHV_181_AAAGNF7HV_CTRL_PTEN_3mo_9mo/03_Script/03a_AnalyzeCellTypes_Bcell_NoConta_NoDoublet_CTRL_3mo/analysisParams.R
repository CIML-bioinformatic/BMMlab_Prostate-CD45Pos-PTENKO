...
ANALYSIS_STEP_NAME = "03a_AnalyzeCellTypes_Bcell_NoConta_NoDoublet_CTRL_3mo"

PATH_ANALYSIS_OUTPUT = file.path( PATH_EXPERIMENT_OUTPUT, ANALYSIS_STEP_NAME)

LITERAL_TITLE = "B cell analysis for CTRL 3 months cells"
...
PATH_SEURAT_OBJECT_INTEGRATION = file.path( PATH_PROJECT, 
                         ...
                         "05_Output", 
                         "03a_AnalyzeCellTypes_Bcell_NoConta_NoDoublet",
                         "Resolution_0.2", 
