...
ANALYSIS_STEP_NAME = "02_CompareConditions_CompositionAnalysis_9mo"

PATH_ANALYSIS_OUTPUT = file.path( PATH_EXPERIMENT_OUTPUT, ANALYSIS_STEP_NAME)

LITERAL_TITLE = "Comparison of WT and PTEN KO conditions at 9 months - Analysis of differential composition"
