...
ANALYSIS_STEP_NAME = "03c_AnalyzeCellTypes_Neutrophil_NoConta_NoDoublet"

PATH_ANALYSIS_OUTPUT = file.path( PATH_EXPERIMENT_OUTPUT, ANALYSIS_STEP_NAME)

LITERAL_TITLE = "Neutrophil analysis"
...
PATH_SEURAT_OBJECT_RDS_FILE = file.path( PATH_EXPERIMENT_OUTPUT, 
					  "03c_AnalyzeCellTypes_Neutrophil_NoConta",
					  "Resolution_0.8",
