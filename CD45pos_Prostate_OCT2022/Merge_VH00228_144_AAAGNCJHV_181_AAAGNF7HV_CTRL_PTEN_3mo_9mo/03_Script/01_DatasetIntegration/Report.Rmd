...
read_chunk( path=file.path( WORKING_DIR, "03_filter_NormalizeData.R"));
read_chunk( path=file.path( WORKING_DIR, "04_variableGenes.R"));
read_chunk( path=file.path( WORKING_DIR, "05_cellHeterogeneity_PCA.R"));
read_chunk( path=file.path( WORKING_DIR, "06_cellHeterogeneity_UMAP.R"));
read_chunk( path=file.path( WORKING_DIR, "07_cellHeterogeneity_Clustering.R"));
read_chunk( path=file.path( WORKING_DIR, "08_cellTypeIdentification_Azimuth.R"));
read_chunk( path=file.path( WORKING_DIR, "09_cellTypeIdentification_MarkerGenes.R"));
read_chunk( path=file.path( WORKING_DIR, "10_cellTypeIdentification_ModuleGenes.R"));
...
## Clusters analysis at chosen resolution {.tabset .tabset-fade}
```{r rmd_clustering_chosen_resolution, warning = FALSE, fig.dim = c(9,6)}
<<heterogeneity_identifyClusters_makeClusters_chosenresolution>>
