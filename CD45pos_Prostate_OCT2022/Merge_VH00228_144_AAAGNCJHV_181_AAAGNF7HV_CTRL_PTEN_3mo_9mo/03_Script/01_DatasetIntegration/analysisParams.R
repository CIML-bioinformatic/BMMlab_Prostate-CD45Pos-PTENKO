...
ANALYSIS_STEP_NAME = "01_DatasetIntegration"

PATH_ANALYSIS_OUTPUT = file.path( PATH_EXPERIMENT_OUTPUT, ANALYSIS_STEP_NAME)

LITERAL_TITLE = "Integration of all 9 month datasets"
...
PATH_SAMPLE_10X_FILES_LIST = c( 
  CTRL3mo_1 = file.path( PATH_PROJECT, 
                         "VH00228_144_AAAGNCJHV_181_AAAGNF7HV_CTRL3mo_1", 
                         "05_Output", 
                         "01_CellRangerAnalysis", 
                         "mm10", 
                         "outs",
                         "filtered_feature_bc_matrix"),
  
  CTRL3mo_2 = file.path( PATH_PROJECT, 
  ...
  PTEN3mo_1 = file.path( PATH_PROJECT, 
  ...
  PTEN3mo_2 = file.path( PATH_PROJECT, 
  ...
  CTRL9mo_1 = file.path( PATH_PROJECT, 
  ...
  CTRL9mo_2 = file.path( PATH_PROJECT, 
  ...
  PTEN9mo_1 = file.path( PATH_PROJECT, 
  ...
  PTEN9mo_2 = file.path( PATH_PROJECT, 
