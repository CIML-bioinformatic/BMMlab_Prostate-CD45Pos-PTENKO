...
ANALYSIS_STEP_NAME = "03b_AnalyzeCellTypes_Tcell_NoConta_NoDoublet"
...
PATH_SEURAT_OBJECT_RDS_FILE = file.path( PATH_EXPERIMENT_OUTPUT, 
					  "03b_AnalyzeCellTypes_Tcell_NoConta",
					  "Resolution_0.8",
					  paste0( outputFilesPrefix, "seuratObject_final.RDS")
					 ) 
...
CONTAMINATION_CLUSTERS = c( 16, 17)
