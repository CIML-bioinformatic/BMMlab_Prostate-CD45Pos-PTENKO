...
# gene = "S100a8"
# 
# FeaturePlot( merge_seurat_object, features = c( gene))
# not_null = which( merge_seurat_object@assays$RNA$data[ gene,] > 0)
# summary( merge_seurat_object@assays$RNA$data[ gene, not_null])
# hist( merge_seurat_object@assays$RNA$data[ gene, not_null])
# length( which( merge_seurat_object@assays$RNA$data[ gene,] > 2))
# 
# ctrl_cells = Cells(merge_seurat_object)[ which( merge_seurat_object$orig.condition == CONDITION_NAME_CTRL)]
# pten_cells = Cells(merge_seurat_object)[ which( merge_seurat_object$orig.condition == CONDITION_NAME_PTEN)]
# 
# ctrl_seurat = subset( merge_seurat_object, cells = ctrl_cells)
# pten_seurat = subset( merge_seurat_object, cells = pten_cells)
# 
# 
# violinFeatureByCluster( ctrl_seurat, currentFeature = "S100a8", slot = "data", yLabel = "S100a8 on CTRL")
# violinFeatureByCluster( pten_seurat, currentFeature = "S100a8", slot = "data", yLabel = "S100a8 on PTEN")
# 
# violinFeatureByCluster( ctrl_seurat, currentFeature = "S100a9", slot = "data", yLabel = "S100a9 on CTRL")
# violinFeatureByCluster( pten_seurat, currentFeature = "S100a9", slot = "data", yLabel = "S100a9 on PTEN")
# 
# violinFeatureByCluster( ctrl_seurat, currentFeature = "Ccl8", slot = "data", yLabel = "Ccl8 on CTRL")
# violinFeatureByCluster( pten_seurat, currentFeature = "Ccl8", slot = "data", yLabel = "Ccl8 on PTEN")
# 
# 
# VlnPlot( merge_seurat_object, features = "S100a8", split.by = "ident")
# VlnPlot( merge_seurat_object, features = "S100a9", split.by = "ident")
# VlnPlot( merge_seurat_object, features = "Ccl8", split.by = "ident")
# 
# table( merge_seurat_object$orig.condition)
