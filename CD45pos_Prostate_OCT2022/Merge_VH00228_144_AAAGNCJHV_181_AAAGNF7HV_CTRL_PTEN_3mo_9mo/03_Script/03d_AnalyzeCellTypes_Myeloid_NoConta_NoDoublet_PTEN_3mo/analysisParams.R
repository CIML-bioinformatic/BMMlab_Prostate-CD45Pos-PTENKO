...
ANALYSIS_STEP_NAME = "03d_AnalyzeCellTypes_Myeloid_NoConta_NoDoublet_PTEN_3mo"

PATH_ANALYSIS_OUTPUT = file.path( PATH_EXPERIMENT_OUTPUT, ANALYSIS_STEP_NAME)

LITERAL_TITLE = "Myeloid analysis for PTEN 3 months cells"
...
PATH_SEURAT_OBJECT_INTEGRATION = file.path( PATH_PROJECT, 
                         ...
                         "05_Output", 
                         "03d_AnalyzeCellTypes_Myeloid_NoConta_NoDoublet",
                         "Resolution_0.8", 
