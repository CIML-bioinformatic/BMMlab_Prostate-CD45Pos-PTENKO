...
# Suset the seurat object with the selected the cells and relevel the seurat clusters factor
...
# Show the dispersion of cell type prediction (L1) to check for the dataser composition
