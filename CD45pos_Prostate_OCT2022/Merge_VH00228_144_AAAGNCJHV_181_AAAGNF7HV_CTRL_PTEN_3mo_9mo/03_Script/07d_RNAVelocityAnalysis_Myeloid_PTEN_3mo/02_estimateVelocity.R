...
cat("<HR>")
svg( file.path( PATH_ANALYSIS_EXTRA_OUTPUT, paste0( CLUSTER_GROUP, "_RNAVelocity_PTEN_3mo_AllArrows.svg")))
par( mfrow = c(1,1))
...
svg( file.path( PATH_ANALYSIS_EXTRA_OUTPUT, paste0( CLUSTER_GROUP, "_RNAVelocity_PTEN_3mo_GridArrows.svg")))
par( mfrow = c(1,1))
show.velocity.on.embedding.cor( seurat_emb,
                                rvel.cd,
                                n=100,
