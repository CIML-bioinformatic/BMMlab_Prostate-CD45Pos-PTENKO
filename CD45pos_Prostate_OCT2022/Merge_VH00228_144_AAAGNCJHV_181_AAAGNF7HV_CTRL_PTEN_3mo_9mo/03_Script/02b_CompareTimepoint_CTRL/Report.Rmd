...
### Date versus cluster
```{r rmd_date_vs_cluster_distribution, fig.dim= c( 12,10)}
<<date_vs_cluster_distribution>>
```

### Cluster versus date
```{r rmd_cluster_vs_date_distribution, fig.dim= c( 12,10)}
<<cluster_vs_date_distribution>>
```


### Date versus cell type
```{r rmd_date_vs_celltypeL1_distribution, fig.dim= c( 12,10)}
<<date_vs_celltypeL1_distribution>>
```
