...
read_chunk( file.path( WORKING_DIR, "90_finalize.R"));

# Import chunks from source files
```

---
title: `r paste( SCIENTIFIC_PROJECT_NAME, ANALYSIS_STEP_LITTERAL_DESCRIPTION, paste( "Condition", SELECTED_CONDITION, CLUSTER_GROUP), sep =" - ")`
---
...
### Estimate Velocity of cells {.tabset .tabset-fade}
```{r estimateVelocity}
<<estimate_velocity>>
```
