...
cluster.label <- r$clusters$PCA[[ "seurat_clusters"]]
# cell.colors <- sccore:::fac2col(cluster.label)
cell.colors = CLUSTER_COLOR_PANEL[ cluster.label]
...
seurat_emb_3mo = as.matrix( umap_embedding[ which( umap_embedding$date == DATE_NAME_3MO), c("umap_1", "umap_2")])
seurat_emb_9mo = as.matrix( umap_embedding[ which( umap_embedding$date == DATE_NAME_9MO), c("umap_1", "umap_2")])
...
write.csv( data.frame( gene_name = sort( intersect(rownames(emat),rownames(nmat)))),
           file = file.path( PATH_ANALYSIS_EXTRA_OUTPUT, "velocyto_validated_genes.csv"))
...
cat("#### All cells")
cat("\n \n")
svg( file.path( PATH_ANALYSIS_EXTRA_OUTPUT, paste0( CLUSTER_GROUP, "_RNAVelocity_3mo_9mo_AllArrows.svg")))
par( mfrow = c(1,1))
...
svg( file.path( PATH_ANALYSIS_EXTRA_OUTPUT, paste0( CLUSTER_GROUP, "_RNAVelocity_3mo_9mo_GridArrows.svg")))
par( mfrow = c(1,1))
show.velocity.on.embedding.cor( seurat_emb,
                                rvel.cd,
                                n=100,
...
cat("#### 3mo cells")
cat("\n \n")
svg( file.path( PATH_ANALYSIS_EXTRA_OUTPUT, paste0( CLUSTER_GROUP, "_RNAVelocity_3mo_AllArrows.svg")))
par( mfrow = c(1,1))
show.velocity.on.embedding.cor( seurat_emb_3mo,
                                rvel.cd,
                                n=100,
                                scale='sqrt',
                                cell.colors=ac( cell.colors, alpha=0.5),
...
svg( file.path( PATH_ANALYSIS_EXTRA_OUTPUT, paste0( CLUSTER_GROUP, "_RNAVelocity_3mo_GridArrows.svg")))
par( mfrow = c(1,1))
show.velocity.on.embedding.cor( seurat_emb_3mo,
                                rvel.cd,
                                n=100,
...
svg( file.path( PATH_ANALYSIS_EXTRA_OUTPUT, paste0( CLUSTER_GROUP, "_RNAVelocity_9mo_AllArrows.svg")))
par( mfrow = c(1,1))
show.velocity.on.embedding.cor( seurat_emb_9mo,
                                rvel.cd,
                                n=100,
                                scale='sqrt',
                                cell.colors=ac( cell.colors, alpha=0.5),
...
svg( file.path( PATH_ANALYSIS_EXTRA_OUTPUT, paste0( CLUSTER_GROUP, "_RNAVelocity_9mo_GridArrows.svg")))
par( mfrow = c(1,1))
show.velocity.on.embedding.cor( seurat_emb_9mo,
                                rvel.cd,
                                n=100,
