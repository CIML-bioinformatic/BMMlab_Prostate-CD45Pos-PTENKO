...
ANALYSIS_STEP_NAME = "04d_CompareTimepoint_Myeloid_CTRL"

PATH_ANALYSIS_OUTPUT = file.path( PATH_EXPERIMENT_OUTPUT, ANALYSIS_STEP_NAME)

LITERAL_TITLE = "Comparison of 3 months and 9 month date for Myeloid in CTRL condition"
...
SELECTED_CELL_TYPE = "Myeloid cell"
