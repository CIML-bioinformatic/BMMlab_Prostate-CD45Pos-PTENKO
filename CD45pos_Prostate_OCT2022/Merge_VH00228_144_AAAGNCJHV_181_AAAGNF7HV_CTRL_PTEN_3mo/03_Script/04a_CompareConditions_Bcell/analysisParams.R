...
PATH_SEURAT_OBJECT_RDS_FILE = file.path( PATH_EXPERIMENT_OUTPUT, "03a_AnalyzeCellTypes_Bcell", "Resolution_0.4", paste0( outputFilesPrefix, "seuratObject_final.RDS"));
