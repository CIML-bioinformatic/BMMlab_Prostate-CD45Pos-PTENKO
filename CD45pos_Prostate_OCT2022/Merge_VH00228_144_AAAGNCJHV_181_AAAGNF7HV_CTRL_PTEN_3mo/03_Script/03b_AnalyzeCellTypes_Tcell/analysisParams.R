...
ANALYSIS_STEP_NAME = "03b_AnalyzeCellTypes_Tcell"

PATH_ANALYSIS_OUTPUT = file.path( PATH_EXPERIMENT_OUTPUT, ANALYSIS_STEP_NAME)

LITERAL_TITLE = "T cells analysis"

# =========================
# DATA TO LOAD VARIABLES
# =========================

# Retrieve result of previous Heterogeneity Analysis
PATH_SEURAT_OBJECT_RDS_FILE = file.path( PATH_EXPERIMENT_OUTPUT, 
					  "01_DatasetIntegration",
					  "Resolution_0.4",
					 paste0( SCIENTIFIC_PROJECT_NAME, "_", SCIENTIFIC_SUBPROJECT_NAME, "_", EXPERIMENT_NAME, "_seuratObject_final.RDS")
					 ) 
...
# Selected clusters for this cell type analysis
SELECTED_CELL_TYPE = "T cell"
SELECTED_CLUSTERS = c( 2, 4, 8, 17, 20)
...
FINDCLUSTERS_RESOLUTION_RANGE = c( 0.4, 0.6, 0.8, 1.0)
