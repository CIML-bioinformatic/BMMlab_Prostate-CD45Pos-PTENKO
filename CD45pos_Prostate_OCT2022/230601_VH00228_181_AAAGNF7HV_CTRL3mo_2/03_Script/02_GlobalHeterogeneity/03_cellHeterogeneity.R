...
if( SAMPLE_NAME == SAMPLE_ALL){
  ...
  plotDimReduc_WT = plot_ly(dimReducData_WT,
    ...
    #browsable(
  div( style = paste("display: flex; align-items: center; justify-content: center;", if(.SHOWFLEXBORDERS) "border-style: solid; border-color: red;"),
       div(plotDimReduc_WT, style = paste("flex : 0 0 800px;", if(.SHOWFLEXBORDERS) "border-style: solid; border-color: blue;")))
  #)
...
if( SAMPLE_NAME == SAMPLE_ALL){
  ...
  #Plot the KO cells UMAP in interactive mode
  ...
  #browsable(
  div( style = paste("display: flex; align-items: center; justify-content: center;", if(.SHOWFLEXBORDERS) "border-style: solid; border-color: red;"),
       div(plotDimReduc_KO, style = paste("flex : 0 0 800px;", if(.SHOWFLEXBORDERS) "border-style: solid; border-color: blue;")))
  #)
...
for( groupid in names( GROUP_GENES)){ 
  ...
  module_score_df = sc10x@meta.data[ , c( "seurat_clusters", "HTO_classification", module_name)]
  module_score_df$HTO_classification = factor( module_score_df$HTO_classification, levels = c( SAMPLE_WT, SAMPLE_KO))
  print(
    ggplot( module_score_df, 
      ...
      ggtitle( paste( "Module scores of", groupid, "by cluster and condition", "\nwith mean and standard deviation"))
  )
