...
read_chunk( path=file.path( WORKING_DIR, "10_KEGGPathwayAnalysis.R"));
...
### Cells distribution {.tabset .tabset-fade}
```{r rmd_heterogeneity_identifyClusters_makeClusters, fig.dim = c(8, 8)}
...
```{r rmd_heterogeneity_Azimuth, fig.dim = c(8, 8)}
...
## KEGG Pathways analysis {.tabset .tabset-fade}

```{r rmd_kegg_pathway_analysis}
