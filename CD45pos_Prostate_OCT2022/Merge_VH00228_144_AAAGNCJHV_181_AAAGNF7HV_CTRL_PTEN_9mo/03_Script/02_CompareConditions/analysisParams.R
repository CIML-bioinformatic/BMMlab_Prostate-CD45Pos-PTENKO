...
ANALYSIS_STEP_NAME = "02_CompareConditions"

PATH_ANALYSIS_OUTPUT = file.path( PATH_EXPERIMENT_OUTPUT, ANALYSIS_STEP_NAME)

LITERAL_TITLE = "Comparison of WT and PTEN KO conditions"
...
PATH_SEURAT_OBJECT_RDS_FILE = file.path( PATH_EXPERIMENT_OUTPUT, "01_DatasetIntegration", "Resolution_0.4", paste0( outputFilesPrefix, "seuratObject_final.RDS"));
