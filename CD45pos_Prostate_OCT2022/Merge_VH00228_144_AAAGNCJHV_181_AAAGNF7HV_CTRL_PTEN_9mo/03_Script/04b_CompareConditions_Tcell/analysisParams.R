...
ANALYSIS_STEP_NAME = "04b_CompareConditions_Tcell"

PATH_ANALYSIS_OUTPUT = file.path( PATH_EXPERIMENT_OUTPUT, ANALYSIS_STEP_NAME)

LITERAL_TITLE = "Comparison of WT and PTEN KO conditions : T cells"
...
PATH_SEURAT_OBJECT_RDS_FILE = file.path( PATH_EXPERIMENT_OUTPUT, "03b_AnalyzeCellTypes_Tcell", "Resolution_0.8", paste0( outputFilesPrefix, "seuratObject_final.RDS"));
