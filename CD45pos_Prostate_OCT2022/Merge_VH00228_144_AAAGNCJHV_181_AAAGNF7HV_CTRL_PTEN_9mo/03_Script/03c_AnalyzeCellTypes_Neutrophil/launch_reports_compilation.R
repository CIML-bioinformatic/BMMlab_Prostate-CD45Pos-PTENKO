...
assign( "PATH_ANALYSIS_OUTPUT" , file.path( paramsEnv$ORIGINAL_PATH_ANALYSIS_OUTPUT, paste0( "Resolution_", paramsEnv$FINDCLUSTERS_RESOLUTION)), env = paramsEnv )
...
rmarkdown::render( input = file.path( WORKING_DIR, "Report.Rmd"),
                   ...
                   output_file  = paste0( SCIENTIFIC_PROJECT_NAME, "_", EXPERIMENT_NAME, "_", ANALYSIS_STEP_NAME, "_", INTEGRATION_SAMPLE_NAME, ".html"),
                   quiet = FALSE)
