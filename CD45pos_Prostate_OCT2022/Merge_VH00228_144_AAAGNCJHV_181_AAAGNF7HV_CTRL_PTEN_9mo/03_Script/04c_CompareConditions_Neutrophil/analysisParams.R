...
ANALYSIS_STEP_NAME = "04c_CompareConditions_Neutrophil"

PATH_ANALYSIS_OUTPUT = file.path( PATH_EXPERIMENT_OUTPUT, ANALYSIS_STEP_NAME)

LITERAL_TITLE = "Comparison of WT and PTEN KO conditions : Neutrophil"
...
PATH_SEURAT_OBJECT_RDS_FILE = file.path( PATH_EXPERIMENT_OUTPUT, "03c_AnalyzeCellTypes_Neutrophil", "Resolution_0.4", paste0( outputFilesPrefix, "seuratObject_final.RDS"));
