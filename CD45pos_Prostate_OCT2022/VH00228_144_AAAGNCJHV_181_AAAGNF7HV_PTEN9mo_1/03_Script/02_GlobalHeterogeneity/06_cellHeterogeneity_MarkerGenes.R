...
DimPlot( sc10x, group.by = "predicted.celltype.l2", label = TRUE, label.size = 3) + NoLegend()

table( sc10x@meta.data$seurat_clusters, sc10x@meta.data$predicted.celltype.l2)
